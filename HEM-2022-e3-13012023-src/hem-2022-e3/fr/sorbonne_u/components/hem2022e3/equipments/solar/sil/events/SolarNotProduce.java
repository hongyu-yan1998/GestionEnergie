...
/**
 * The class <code>ScolarNotProduce.java</code> 
 *
...
implements SolarPanelEventI {
	 ...
	 */
	public SolarNotProduce(Time timeOfOccurrence) {
	...
	public void executeOn(AtomicModel model) {
		...
		((SolarPanelOperationI) model).stopProduce();
	}
}

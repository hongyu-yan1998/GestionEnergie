...
extends		AbstractCVM
{
	...
	public static final long	DELAY_TO_START_SIMULATION = 4000L;
	...
	public static final String	CLOCK_URI = "electric-blanket-clock";
	...
	public void			deploy() throws Exception
	{
		...
		AbstractComponent.createComponent(
				ElectricBlanket.class.getCanonicalName(),
				new Object[]{isUnderTest, isUnitTesting, isSimulated,
							 simArchitectureURI, ACC_FACTOR, CLOCK_URI});

		AbstractComponent.createComponent(
				ElectricBlanketTester.class.getCanonicalName(),
				new Object[]{ElectricBlanket.INBOUND_PORT_URI, false,
							 CLOCK_URI});
